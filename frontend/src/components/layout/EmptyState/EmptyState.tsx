      ...
      {channelData?.is_direct_message == 1 && (
        <Flex direction='column' gap='3'>
          ...
          {channelData?.is_self_message == 1 ? (
            <Flex direction='column' gap='0'>
              <Text size='2'>
                <strong>This space is all yours.</strong> Draft messages, list your to-dos, or keep links and files
                handy.{' '}
              </Text>
              <Text size='2'>
                And if you ever feel like talking to yourself, don't worry, we won't judge - just remember to bring your
                own banter to the table.
              </Text>
            </Flex>
          ) : (
