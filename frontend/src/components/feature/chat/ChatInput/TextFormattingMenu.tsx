...
import { BiBold, BiItalic, BiListOl, BiListUl, BiSolidQuoteAltRight, BiUnderline } from 'react-icons/bi'
    ...
    <Flex gap='2' align='center' px='1' py='1' className='sm:max-w-[60%] max-w-[100%] overflow-x-auto'>
      ...
      <Flex gap='3' align='center'>
        <Tooltip
          ...
          aria-label={getKeyboardMetaKeyString() + ' + Shift + 7'}
        >
          <IconButton
        ...
        <Tooltip
          content={getKeyboardMetaKeyString() + ' + Shift + 8'}
          aria-label={getKeyboardMetaKeyString() + ' + Shift + 8'}
        >
          <IconButton
      ...
      {/* <Flex gap='3' align='center'>
        <Tooltip
          content={getKeyboardMetaKeyString() + ' + Shift + H'}
          aria-label={getKeyboardMetaKeyString() + ' + Shift + H'}
        >
          <IconButton
