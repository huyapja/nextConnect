...
import { ChannelHistoryFirstMessage } from '@/components/layout/EmptyState/ModalEmptyState'
...
import { ModalMessageItemRenderer } from './ModalMessageListRenderer'
...
const ChatStream = forwardRef<VirtuosoHandle, Props>(
  ({ channelID, showThreadButton = true, pinnedMessagesString, onModalClose, virtuosoRef }, ref) => {
