...
const Appearance = () => {
  ...
  const { data: chatStyle, mutate } = useFrappeGetCall<{ message: { chat_style: 'Simple' | 'Left-Right' } }>(
    ...
    <PageContainer>
      <SettingsContentContainer>
        ...
        <Stack gap='6' pt='2'>
          ...
          <ChatLayouts
            chatStyle={chatStyle?.message?.chat_style ?? 'Simple'}
    ...
    <Stack gap='3'>
      ...
      <Box maxWidth='600px'>
        {chatStyle && (
          <RadioCards.Root
            value={chatStyle}
            onValueChange={(value) => setChatStyle(value)}
